          ...
          <div className="bg-gray-900 rounded-xl border border-purple-500/30 p-6 max-w-md w-full">
            ...
            <div className="bg-purple-900/30 p-4 rounded-lg border border-purple-600 mb-6">
              ...
              <ul className="text-sm text-gray-300 list-disc pl-5 mt-2 space-y-1">
                <li>Rate candidate responses with star ratings</li>
                <li>View candidate resume and skills</li>
                <li>Access suggested interview questions</li>
                <li>End interview and submit evaluation</li>
              </ul>
            </div>
            <div className="flex justify-end space-x-4">
              ...
              <button
                ...
                className="px-6 py-3 rounded-lg bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-500 hover:to-blue-500 text-white transition-colors"
              >
                Join as Interviewer
              </button>
            </div>
